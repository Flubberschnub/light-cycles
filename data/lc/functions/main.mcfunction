...
##unique cycleid
execute as @a[predicate=lc:lc/holdingclosedbaton,predicate=!lc:lc/riding_cycle,tag=!rezzedvehicle] run function lc:id/getuniqueid
...
execute as @a[tag=rezzedvehicle] run function lc:match/player/removerezzedtag

##rez and de-rez
execute as @a[predicate=lc:lc/holdingclosedbaton,scores={clickbaton=1..},predicate=!lc:lc/riding_cycle,tag=!rezzedvehicle] run function lc:rez/rezzing
...
##rez animations
execute as @e[tag=rezzing,tag=cyclestand] run function lc:rez/animate/tick

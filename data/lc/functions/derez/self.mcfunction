...
execute unless entity @e[tag=matchedid,tag=cyclestand,tag=noclipbaton] at @s as @s run function lc:rez/batons/derez
execute as @e[tag=matchedid,tag=cyclestand,tag=noclipbaton,tag=!exploded] at @s run function lc:rez/batons/derez

...
execute if entity @a[predicate=!lc:lc/braking,tag=matchedid] if entity @e[type=armor_stand,nbt={ArmorItems:[{},{},{},{id:"minecraft:diamond",Count:1b,tag:{CustomModelData:25002}}]}] run replaceitem entity @s armor.head diamond{CustomModelData:25}

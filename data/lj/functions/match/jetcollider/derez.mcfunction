...
execute at @e[tag=jetstand,tag=matchedid] unless entity @a[tag=matchedid,predicate=lc:lc/riding_jet] run playsound lightcycle.derez master @a[distance=..30] ~ ~ ~ 1 1

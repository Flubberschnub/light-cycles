...
execute unless score @a[tag=matchedid,limit=1] circuitcolor matches 2.. run summon minecraft:armor_stand ~600 0 ~600 {NoGravity:1b,Invulnerable:1b,Fire:400,Marker:1b,Invisible:1b,PersistenceRequired:1b,Pose:{Head:[0.001f,0.001f,0.001f]},Tags:["lightjet","bullet","newbullet"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:light_blue_dye",Count:1b,tag:{CustomModelData:3}}],CustomName:'{"text":"bullet"}'}
execute if score @a[tag=matchedid,limit=1] circuitcolor matches 2 run summon minecraft:armor_stand ~600 0 ~600 {NoGravity:1b,Invulnerable:1b,Fire:400,Marker:1b,Invisible:1b,PersistenceRequired:1b,Pose:{Head:[0.001f,0.001f,0.001f]},Tags:["lightjet","bullet","newbullet"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:orange_dye",Count:1b,tag:{CustomModelData:3}}],CustomName:'{"text":"bullet"}'}
execute if score @a[tag=matchedid,limit=1] circuitcolor matches 3 run summon minecraft:armor_stand ~600 0 ~600 {NoGravity:1b,Invulnerable:1b,Fire:400,Marker:1b,Invisible:1b,PersistenceRequired:1b,Pose:{Head:[0.001f,0.001f,0.001f]},Tags:["lightjet","bullet","newbullet"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:green_dye",Count:1b,tag:{CustomModelData:3}}],CustomName:'{"text":"bullet"}'}

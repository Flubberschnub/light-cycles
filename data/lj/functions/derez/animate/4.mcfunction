...
execute if score @s rezanimate matches 4 run replaceitem entity @s armor.head minecraft:feather{CustomModelData:45}
execute if score @s rezanimate matches 5 run replaceitem entity @s armor.head minecraft:feather{CustomModelData:46}
execute if score @s rezanimate matches 7 run replaceitem entity @s armor.head minecraft:feather{CustomModelData:47}
execute if score @s rezanimate matches 9 run replaceitem entity @s armor.head minecraft:feather{CustomModelData:48}

##tiltleft
execute as @e[tag=jetfacingy,tag=matchedid] at @e[tag=playerfacing,tag=matchedid,limit=1] run function aestd1:entity/get_distance
execute as @e[tag=jetfacingy,tag=matchedid] run scoreboard players operation @s tiltangle = @s aestd.math.out
execute as @e[tag=jetfacingy,tag=matchedid] run function lj:rotate/tilt/getangleup
